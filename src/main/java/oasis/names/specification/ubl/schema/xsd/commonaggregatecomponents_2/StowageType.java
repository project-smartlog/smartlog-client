...
public class StowageType {
    ...
    protected List<oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.LocationType> location;
     ...
     * 
     */
    public List<oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.LocationType> getLocation() {
        if (location == null) {
            location = new ArrayList<oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.LocationType>();
        }
