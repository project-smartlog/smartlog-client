...
@XmlRootElement(name = "ForwardingInstructions")
@XmlType(name = "ForwardingInstructions", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class ForwardingInstructions {
    ...
    @XmlElement(name = "UBLExtensions", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2", required = false)
    ...
    public String toString() {
    	String s = "\n Printing Forwarding Instruction properties: \n";
    	s += "ID:" + this.getID() + "\n";
    	s += "UBLVersionID:" + this.getUBLVersionID() + "\n";
    	s += "Issue date:" + this.issueDate + "\n";
    	return s;
    }
